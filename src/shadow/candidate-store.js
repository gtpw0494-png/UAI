...
export class CandidateStore{
  ...
  setState(id,state,extra={}){
    ...
    const body={...cur.record,...extra,state,updatedAt:iso()};const r=this.db.cas("shadow-candidate",id,cur.version,body,{type:"candidate.transition",to:state});
    return r.state==="SUCCESS"?body:r;
  }
}
