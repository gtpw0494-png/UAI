...
const schemas=new Map([
  ...
  ["POST /api/control-plane/dispatch",{type:"object",required:["queue"],properties:{queue:{enum:["shadow","light"]},workerId:{type:"string",minLength:1,maxLength:256}},additionalProperties:false}],
  ["POST /api/control-plane/maintenance",{type:"object",properties:{now:{type:"integer",minimum:0}},additionalProperties:false}],
  ["POST /api/shadow/dispatch",{type:"object",properties:{workerId:{type:"string",minLength:1,maxLength:256}},additionalProperties:false}],
  ["POST /api/shadow/maintenance",{type:"object",properties:{now:{type:"integer",minimum:0}},additionalProperties:false}],
  ["POST /api/shadow/runs",{type:"object",required:["agentType","objective"],properties:{agentType:{type:"string",minLength:1,maxLength:128},objective:{type:"string",minLength:1,maxLength:20000},budget:{type:"object"},parentRunId:{type:["string","null"],maxLength:256},provenance:{type:"object"},simulationInput:{type:"object"}},additionalProperties:true}],
  ...
  ["POST /api/light/dispatch",{type:"object",properties:{workerId:{type:"string",minLength:1,maxLength:256}},additionalProperties:false}],
  ["POST /api/light/maintenance",{type:"object",properties:{now:{type:"integer",minimum:0}},additionalProperties:false}],
