...
export function routeSecurity(method,path){
  ...
  if(/\/purge$|\/forget-source$|\/source\/rollback$|\/model\/train$|\/model\/tokenizer\/train$|\/model\/(?:promote|rollback)$|\/vision\/(?:promote|rollback)$|\/audio\/(?:promote|rollback)$|\/knowledge\/learning\/train$|\/knowledge\/model\/(?:promote|rollback)$|\/knowledge\/research\/schedule$|\/knowledge\/cloud\/(?:recover|sync)$|\/selfdev\/promote$|\/develop\/apply$|\/fabrication\/job$|\/autonomy\/grant$|^\/api\/promotion\/|\/governance\/emergency\/release$|\/governance\/trusted-devices\/(?:enroll|revoke)$/.test(p))risk="high";
