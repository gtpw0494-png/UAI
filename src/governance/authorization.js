...
export function routeSecurity(method,path){
  ...
  if(/\/purge$|\/forget-source$|\/source\/rollback$|\/model\/train$|\/model\/tokenizer\/train$|\/model\/(?:promote|rollback)$|\/knowledge\/learning\/train$|\/knowledge\/model\/(?:promote|rollback)$|\/knowledge\/research\/schedule$|\/selfdev\/promote$|\/develop\/apply$|\/fabrication\/job$|\/autonomy\/grant$|^\/api\/promotion\/|\/governance\/emergency\/release$|\/governance\/trusted-devices\/(?:enroll|revoke)$/.test(p))risk="high";
